                ...
                <div className="animate-fade-in">
                  ...
                  <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2 pt-4">
                      <button type="button" className="bg-[#34A853] hover:bg-[#2b8f45] text-white font-bold py-3 px-8 rounded-xl transition-colors">
                        Save Changes
                      </button>
                    </div>
                  </form>
              ...
              {activeTab === 'addresses' && (
                <div className="animate-fade-in">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {/* Existing Address */}
                    <div className="border border-gray-200 rounded-xl p-5 relative group hover:border-[#34A853] transition-colors">
                      ...
                      <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="p-1.5 text-gray-400 hover:text-[#34A853] bg-gray-50 rounded-md"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></button>
                        <button className="p-1.5 text-gray-400 hover:text-red-500 bg-gray-50 rounded-md"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg></button>
                      </div>
                    </div>

                    {/* Add New Address Button */}
                    <button className="border-2 border-dashed border-gray-300 rounded-xl p-5 flex flex-col items-center justify-center text-gray-500 hover:bg-gray-50 hover:text-[#34A853] hover:border-[#34A853] transition-all min-h-[140px]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="border border-gray-200 rounded-xl p-5 relative group hover:border-[#34A853] transition-colors">
                      <div className="flex items-center justify-between mb-4">
                        <div className="w-12 h-8 bg-[#1434CB] rounded px-2 flex items-center justify-center text-white font-bold text-xs italic">
                          VISA
                        </div>
                        <span className="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded-md">Default</span>
                      </div>
                      <p className="font-bold text-gray-900 tracking-widest mb-1">•••• •••• •••• 4242</p>
                      <p className="text-sm text-gray-500">Expires 12/28</p>
                      <button className="absolute top-4 right-4 p-1.5 text-gray-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity">
