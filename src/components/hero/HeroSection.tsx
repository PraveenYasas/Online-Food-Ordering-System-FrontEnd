...
import heroBg from '../../assets/Hero.jpg' // Make sure image is in src/assets/
    ...
    <section className="relative h-[550px] w-full flex items-center px-4 sm:px-12 overflow-hidden">
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-2">
          ...
          <button className="bg-black text-white px-10 py-4 font-bold text-lg hover:bg-zinc-800 transition-colors duration-200 rounded-md md:rounded-none">
            Find Food
          </button>
        </div>
