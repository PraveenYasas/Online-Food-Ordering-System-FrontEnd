        ...
        {isLoggedIn ? (
          <>
            ...
            <button onClick={onOpenCart} className="p-2 hover:bg-gray-100 rounded-full relative transition-colors ml-1 cursor-pointer">
              ...
              {cartItemCount > 0 && <span className="absolute top-0 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-bold leading-none text-white transform translate-x-1/4 -translate-y-1/4 bg-[#d81b60] rounded-full border-2 border-white">{cartItemCount}</span>}
            </button>
          </>
        ) : (
          <>
